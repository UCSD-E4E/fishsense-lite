...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "dive_frame_group_id", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column("image_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["dive_frame_group_id"],
            ["diveframegroup.id"],
            name=op.f("diveframegroupimagemapping_dive_frame_group_id_fkey"),
        ),
        sa.ForeignKeyConstraint(
            ["image_id"],
            ["image.id"],
            name=op.f("diveframegroupimagemapping_image_id_fkey"),
        ),
        sa.PrimaryKeyConstraint(
            "dive_frame_group_id",
            "image_id",
            name=op.f("diveframegroupimagemapping_pkey"),
        ),
    )
    op.create_table(
        "diveframegroup",
        ...
        sa.ForeignKeyConstraint(
            ["dive_id"], ["dive.id"], name=op.f("diveframegroup_dive_id_fkey")
        ),
